...
import examples.android.md.rx.rv.com.org.simplervrx.services.DummyService;
...
public class EventBusFragment extends Fragment {
    ...
    public void onStart() {
        ...
        //Register fragment as listener of event(EventBus)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("parameter", "Initial Value");
    ...
    @Subscribe
    public void onEvent(HandlerEvent event){
        Log.d(TAG, "onEvent");
