...
public class ParentFragment extends Fragment {
    ...
    private Child1Fragment child1Fragment;
    private Child2Fragment child2Fragment;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        child1Fragment = new Child1Fragment();
        child2Fragment = new Child2Fragment();

        getFragmentManager()
                .beginTransaction()
                .add(R.id.frame_fragment_child_1, child1Fragment, child1Fragment.getClass().getSimpleName())
                .add(R.id.frame_fragment_child_2, child2Fragment, child2Fragment.getClass().getSimpleName())
